      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold">ServiceCompany</h3>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400 space-y-2">
              ...
              <p>
                <Link href="tel:+1234567890" className="hover:text-white transition-colors duration-300">
                  +1 (234) 567-890
                </Link>
              </p>
              <p>
                <Link
                  href="mailto:info@servicecompany.com"
                  className="hover:text-white transition-colors duration-300"
                >
                  info@servicecompany.com
                </Link>
              </p>
            </address>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} ServiceCompany. All rights reserved.
            </p>
          </div>
        </div>
      </div>
